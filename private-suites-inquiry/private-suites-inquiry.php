...
function psi_render_inquiry_form( $atts ) {
    ...
    ob_start();
    ?>
    <div class="psi-modal-overlay is-open" style="position:relative; background:#eeede5; padding:0; display:block;">
        <div class="psi-modal">
            <h2 class="psi-form-heading">Book Space!</h2>

            <?php if ( $is_locked ) : ?>
                <div class="psi-locked-info-bar">
            ...
            <form id="psi-inquiry-form" class="psi-form-grid" novalidate>
                ...
                <div class="psi-field">
                    ...
                    <input type="text" name="full_name" id="psi-full-name" required placeholder="Full Name" />
                </div>
                <div class="psi-field">
                ...
                <div class="psi-field">
                    ...
                    <input type="tel" name="phone" id="psi-phone" required placeholder="Phone Number" />
                ...
                <div class="psi-field">
                    <!-- <label>Email</label> -->
                    <input type="email" name="email" id="psi-email" required placeholder="Email" />
                    <!-- <small class="psi-field-error-msg" id="psi-email-error" style="display:none; color:#d63638;"></small> -->
                </div>
                <div class="psi-field">
                    <!-- <label>Start Date</label> -->
                    <div class="psi-date-field">
                        <input type="text" name="start_date" id="psi-start-date" required readonly placeholder="Start Date" />
                ...
                <div class="psi-field">
                    ...
                    <div class="psi-date-field">
                        <input type="text" name="end_date" id="psi-end-date" required readonly placeholder="End date" />
                        <div class="psi-date-icon"><span class="dashicons"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="5" width="18" height="16" rx="2"></rect><line x1="3" y1="10" x2="21" y2="10"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="16" y1="2" x2="16" y2="6"></line></svg></span></div>
                ...
                <div class="psi-field">
                    ...
                    <div class="psi-select-wrap">
                        <select name="manager_seats" id="psi-manager-seats">
                            <option value="">Manager Cabins</option>
